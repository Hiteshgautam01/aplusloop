...
const BrandingServices = () => {
  ...
  // Content sections with exact texts from the user
  const sections = [
    {
  ...
  return (
    <div className="font-sans bg-gray-50">
      {/* Main Branding Section with Sticky-Scroll */}
          ...
          <div className="lg:hidden">
            ...
            >
              ...
              >
                ...
                appeal, we'll create a solution specifically for your goals and
                ambitions. Combining data and insight with our passion for
                design, we develop emotionally resonant brand identities and
                experiences. And we constantly challenge norms and assumptions –
                all in search of ideas that accelerate your growth and help you
