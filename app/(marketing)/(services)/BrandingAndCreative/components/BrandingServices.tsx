...
const CollapsibleSection = ({
  ...
  return (
    <div className={`mb-6 border-b ${borderColor} pb-4 last:border-0 last:pb-0`}>
      <button 
        onClick={onToggle}
        className="flex justify-between items-center w-full py-3 text-left transition-all duration-300"
        aria-expanded={isActive}
      >
        <h3 className={`text-xl font-semibold ${titleColor} transition-colors duration-300`}>
          {title}
        </h3>
        <motion.div
    ...
    <div className="relative w-full h-full aspect-square rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-white mb-2">Branding Excellence</h3>
          <p className="text-white/80">Crafting memorable brand experiences that resonate and inspire</p>
        </div>
      </div>
    </div>
  );
  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>We start by asking questions. Lots of them. We then analyse the answers, and the insights of our Research and Strategy teams, and use it all as the foundation for a future-oriented brand strategy. This is how we ensure your brand attracts and engages all the right people.</p>
          <div className="mt-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>With the strategy in place, we can now start creating the concept. We explore, visualise, communicate and test different ideas and directions. And we push the creative limits to ensure we create something truly great.</p>
          <div className="mt-4">
            <p className="font-medium mb-2">Key steps:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>Mood boarding</li>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Once the concept is agreed and the direction is set, we start making things real. We determine the look and feel, create the brand guidelines, and bring a holistic brand identity to life.</p>
          <div className="mt-4">
            <p className="font-medium mb-2">Key steps:</p>
            <ul className="list-disc pl-5 space-y-1">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Without context, branding is just a set of pretty pixels. We use the brand identity we've created to produce joined-up digital experiences – ones that appeal to users' emotions and build loyalty towards your products.</p>
          <div className="mt-4">
            <p className="font-medium mb-2">Key steps:</p>
            <ul className="list-disc pl-5 space-y-1">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Our comprehensive branding package includes all the essential elements needed to establish and grow your brand. From strategy to implementation, we've got you covered with a tailored approach that reflects your unique vision and goals.</p>
          <div className="mt-4 p-4 bg-pink-100/50 rounded-lg">
            <p className="font-medium text-pink-800">Complete solution including:</p>
    ...
    <div className="font-sans bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 relative">
            ...
            <div className="lg:w-1/2">
              ...
              >
                <h2 className="text-3xl font-bold mb-3 text-gray-900">Our Approach to Branding Services</h2>
                <p className="text-xl mb-6 text-gray-600">There's no brand quite like yours.</p>
      ...
      <div className="bg-gradient-to-r from-pink-600 to-pink-800 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold mb-4">Curious what's the optimal creative process for your product and challenges?</h3>
          <p className="text-white/80 mb-6">Let's discover the perfect approach for your unique brand journey together.</p>
