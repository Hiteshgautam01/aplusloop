...
import { Shield, AlertCircle, BarChart4, Clock, Zap, ChevronRight, TrendingUp, Lock, Server } from "lucide-react";
...
const RiskManagement = () => {
  return (
    <section id="risk-management" className="pt-24 bg-gradient-to-b from-transparent to-white">
      {/* Header Section */}
      <motion.div
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Comprehensive risk assessment and vulnerability testing to strengthen
            your security posture with cutting-edge methodologies
          </p>
        </div>
      </motion.div>
      ...
      >
        <motion.div variants={fadeInUp} custom={1}>
          ...
          <ul className="space-y-4">
            {[
              { icon: Shield, text: "24/7 threat monitoring and detection", color: "text-blue-600" },
              { icon: AlertCircle, text: "Incident response and management", color: "text-orange-600" },
              { icon: BarChart4, text: "Security analytics and reporting", color: "text-green-600" }
            ].map((item, index) => (
              <motion.li 
                key={index}
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            Leverage cutting-edge technology to identify and mitigate security risks before they become threats
          </motion.p>
            ...
            {[
              {
                ...
                description: "Automated scanning tools to identify security vulnerabilities across your infrastructure and applications.",
                color: "blue",
              ...
              },
              {
                ...
                description: "Advanced penetration testing tools to simulate real-world attacks and identify security weaknesses.",
                color: "purple",
              ...
              },
              {
                ...
                description: "Data-driven risk assessment tools to quantify and prioritize security risks based on your business context.",
                color: "green",
              ...
              >
                ...
                <div className="relative bg-white p-8 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all duration-300 overflow-hidden h-full shadow-sm hover:shadow-md">
                  ...
                  {/* Content */}
                  <h4 className="text-xl font-semibold mb-3 relative z-10 text-gray-900">{tool.title}</h4>
                  <p className="text-gray-600 relative z-10">{tool.description}</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-blue-900 text-white p-12 md:p-20 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              >
                {[
                  { number: "15min", label: "Average Response Time", icon: Clock },
                  { number: "99.9%", label: "Threat Detection Rate", icon: Shield },
                  { number: "24/7", label: "Security Monitoring", icon: TrendingUp }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
