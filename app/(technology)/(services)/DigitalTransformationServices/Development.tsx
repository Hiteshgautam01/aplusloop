...
import { Code, Box, Cpu, Network, Workflow, Server, GitBranch, Layers, ArrowRight, Star } from 'lucide-react';
      ...
      >
        ...
        <div className="mb-20">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-5xl font-light text-center text-gray-800 mb-4"
          >
          ...
          >
            From launch to maintenance, we ensure every app 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    The beginning of software engineering with waterfall methodologies and limited collaboration tools. 
                    Development cycles were lengthy and adaptability was minimal.
                  </p>
                ...
                <div className="order-1 md:order-2 flex justify-center">
                  <motion.div
                    whileHover={{ y: -5, boxShadow: "0 15px 30px -5px rgba(59, 130, 246, 0.15)" }}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                <div className="md:order-2">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Introduction of agile practices, iterative development, and the beginning of DevOps culture. 
                    Teams started to collaborate more efficiently with improved tools.
                  </p>
                  <div className="mt-6 flex gap-4">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Continuous integration/deployment, microservices architecture, and cloud-native development. 
                    Organizations now operate in a fully connected ecosystem with automated pipelines.
                  </p>
                  <div className="mt-6 flex gap-4">
                    <div className="flex items-center text-sm text-blue-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-4">Implementation and modernization of HRMS, CRM, and ERP systems tailored to your organization's needs.</p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-4">Bespoke solutions that align perfectly with your business workflows and operational requirements.</p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-4">End-to-end deployment ensuring performance, security, and continuous value delivery.</p>
