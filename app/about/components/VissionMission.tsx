...
// Define CSS Animation keyframes for the pulse effect
...
const AboutSection = () => {
  ...
  // Apply global animation styles when component mounts
  React.useEffect(() => {
  ...
  return (
    <div className="bg-slate-50 overflow-hidden">
      ...
      <section className="relative py-24 overflow-hidden bg-gradient-to-br from-white to-slate-100">
        ...
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full translate-y-[-250px] bg-blue-300/40 blur-[120px] z-[1] animate-pulse-slow"
          style={{
            backgroundImage:
              "radial-gradient(circle, rgba(96, 165, 250, 0.4), rgba(59, 130, 246, 0.2), rgba(37, 99, 235, 0.1))",
          }}
        ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-[5]">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              >
                <span className="font-semibold">Aplusloop</span> is a
                future-focused technology and marketing solutions company
                headquartered in the UAE, with an expansive presence across
              ...
              >
                <a
                  href="#about"
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-300 flex items-center"
                >
                  Learn More <ChevronRight className="h-4 w-4 ml-1" />
                </a>
                <a
                  href="#contact"
                  className="px-6 py-3 bg-white text-blue-600 font-medium rounded-lg shadow-md border border-blue-100 hover:bg-blue-50 transition-all duration-300"
                >
                  Get in Touch
                </a>
              </motion.div>
            ...
            >
              <motion.div
                className="relative rounded-2xl overflow-hidden bg-white p-3 shadow-2xl shadow-blue-500/10"
              ...
              >
                ...
                <div className="w-full aspect-[4/3] rounded-xl overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-600/90 to-indigo-600/90 mix-blend-multiply opacity-65 z-10"></div>
                  <motion.div
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-8 text-white z-10">
                    ...
                    <p className="text-white/90">
                      Building resilient and high-performing enterprises
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              <div className="grid grid-cols-2 gap-4 relative">
                <motion.div
                  className="col-span-2 rounded-xl overflow-hidden shadow-lg h-64 relative"
                ...
                <motion.div
                  className="rounded-xl overflow-hidden shadow-lg h-40 relative"
                  variants={imageHoverVariants}
                  initial="initial"
                  whileHover="hover"
                >
            ...
            >
              ...
              <div className="prose prose-lg text-gray-600 max-w-none">
                <p>
                  ...
                  future-focused technology and marketing solutions company
                  headquartered in the UAE, with an expansive presence across
                  Dubai, Abu Dhabi, Sharjah, and beyond. We specialize in
                  delivering integrated business consulting, cutting-edge IT
                  services, and transformative digital marketing solutions that
                  help organizations stay ahead in an ever-evolving digital
                  economy.
                </p>
                <p>
                  Our strength lies in a collaborative leadership team of
                  seasoned C-level executives, each bringing deep domain
                  expertise across technology, marketing, and business
                  transformation. This synergy enables us to co-create
                  strategies that are scalable, secure, and tailored to the
                  specific needs of diverse industries.
                </p>
                <p>
                  From on-premise to cloud-based platforms, cybersecurity to
                  digital campaigns, and consulting to implementation, we are
                  your trusted partner in building resilient and high-performing
                  enterprises.
                </p>
              </div>
            ...
            >
              ...
              <div className="p-8 md:p-10">
                ...
                <p className="text-gray-600 leading-relaxed text-lg mb-8">
                  To be a global leader in delivering{" "}
                  <span className="text-blue-600 font-medium">innovative</span>,{" "}
                  <span className="text-blue-600 font-medium">sustainable</span>
                  , and{" "}
                  <span className="text-blue-600 font-medium">
                    human-centered
                  </span>{" "}
                  <span className="font-semibold">
                    Technology, Business Consulting, and Marketing Solutions
                  </span>{" "}
                  that empower businesses to thrive in a connected world.
                </p>
            ...
            >
              ...
              <div className="p-8 md:p-10">
                ...
                <p className="text-gray-600 leading-relaxed text-lg mb-8">
                  ...
                  , we are committed to shaping the future of business by
                  transforming insights into impact. Through a blend of{" "}
                  ...
                  , we help clients unlock measurable value—enhancing customer
                  experiences, optimizing operations, and enabling sustainable
                  growth.
                </p>
