...
export const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <Link
      ...
      className="w-[280px] rounded-xl border border-slate-200 overflow-hidden group hover:shadow-lg hover:border-blue-100 transition-all duration-300 flex flex-col bg-white"
    >
